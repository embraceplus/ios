...
- (void)scrollByOffset:(CGFloat)offset duration:(NSTimeInterval)duration
{
    ...
    else
    {
        ...
        NSLog(@"self.scrollOffset = %f",self.scrollOffset);
    }
}
...
- (void)scrollViewDidEndDragging:(UIScrollView *)scrollView willDecelerate:(BOOL)decelerate
{
    ...
    //NSLog(@"scrollViewDidEndDragging = current = %d,total= %d",[self currentPage],[self numberOfPages]);
}
...
- (void)scrollViewDidEndDecelerating:(UIScrollView *)scrollView
{
    ...
    //NSLog(@"scrollViewDidEndDecelerating = current = %d,total= %d",[self currentPage],[self numberOfPages]);
